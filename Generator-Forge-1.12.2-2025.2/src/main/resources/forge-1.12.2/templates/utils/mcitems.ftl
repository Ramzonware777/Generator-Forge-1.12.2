...
<#function mappedBlockToItem mappedBlock>
    <#if mappedBlock?starts_with("CUSTOM:")>
        <#return mappedElementToRegistryEntry(mappedBlock) + ".asItem()">
    <#elseif hasMetadata(mappedBlock)>
        <#return "Item.getItemFromBlock(" + splitMetadata(mappedBlock)[0] + ")">
    <#else>
        <#return "Item.getItemFromBlock(" + mappedBlock + ")">
    </#if>
</#function>
